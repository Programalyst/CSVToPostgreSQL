...
let csvStream = csv.parseFile('./csv/transactions.csv', {objectMode: true, headers: true })
    ...
    if(counter < 999999) //change the number to the max rows to parse and insert
    {
        ...
        let merchant_category  = row.MERCHANT_CATEGORY;
        let merchant_country = row.MERCHANT_COUNTRY;
